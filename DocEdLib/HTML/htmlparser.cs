...
// important TODOS: 
// HTMLTODO 1. Start tags: The ParseXmlElement function has been modified to be called after both the 
...
// HTMLTODO 2. Invalid element names: However, it might make sense to give the lexical analyzer the ability to identify
...
// HTMLTODO 3. Attributes: The attribute recovery is poor when reading attribute values in quotes - if no closing quotes are found,
...
// HTMLTODO 4: elements with optional closing tags: For elements with optional closing tags, we always close the element if we find
...
// HTMLTODO 5. Nesting: Support for unbalanced nesting, e.g. <b> <i> </b> </i>: this is not presently supported. To support it we may need
...
// HTMLTODO 6. Elements with optional starting tags: there are 4 such elements in the HTML 4 specification - html, tbody, body and head.
...
// HTMLTODO 7: Context: Is it appropriate to keep track of context here? For example, should we only expect td, tr elements when
...
namespace HTMLConverter
{
    ...
    internal class HtmlParser
    {
        ...
        internal static string ExtractHtmlFromClipboardData(string htmlDataString)
        {
            ...
            // HTMLTODO: We assume that indices represented by strictly 10 zeros ("0123456789".Length),
