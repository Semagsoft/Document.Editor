...
namespace HTMLConverter
{
    ...
    internal class HtmlLexicalAnalyzer
    {
        ...
        {
            // HTMLTODO: handle character entities while processing comments, cdata, and directives
            // HTMLTODO: SUGGESTION: we could check if lookahead and previous characters are entities also
            while (true)
            {
        ...
        /// HTMLTODO: only a placeholder for now but later to be replaced with comparisons against
        ...
        {
            // HTMLTODO: put actual code with checks against all combining characters here
            return false;
        }
        ...
        {
            // HTMLTODO: put actual code with checks against all extenders here
            return false;
        }
