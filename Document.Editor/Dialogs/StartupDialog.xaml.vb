...
Public Class StartupDialog
    ...
    Private Sub Window_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        Dim ba As New BannerAds()
        Dim ia As New InterstitialAd()
        'ba.ApplicationId = "27cqmrlhom5k"
        'ba.WidthAd = 90
        'ba.HeightAd = 90
        adHost.Child = ba
        'adHost_Copy.Child = ia
        ba.ShowAd(468, 60, "27cqmrlhom5k")
        'ia.ShowInterstitialAd("27cqmrlhom5k")
    End Sub
